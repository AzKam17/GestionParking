...
--
-- Host: localhost    Database: esatic
-- ------------------------------------------------------
...
CREATE TABLE `type_vehicule` (
  ...
  `nbrDispo` int NOT NULL,
  `prixHoraire` int NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `type_vehicule` VALUES (1,'Moto',24,2000),(2,'Voiture',50,3000),(3,'Camion',25,5000);
...
CREATE TABLE `vehicule` (
  ...
  `type_veh` int NOT NULL,
  `type_stattionnement` int NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-03-19 13:59:18
